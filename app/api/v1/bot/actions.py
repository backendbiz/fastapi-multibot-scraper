...
#    api_key: str = Depends(get_api_key) # Uncomment to enforce API Key auth
    ...
    """
    if request.game_game not in ["pandamaster", "firekirin", "orionstars", "milkywayapp", "juwa777", "vegasx"]:
        raise HTTPException(status_code=400, detail="Supported games: pandamaster, firekirin, orionstars, milkywayapp, juwa777, vegasx")
