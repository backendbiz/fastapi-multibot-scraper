...
class UltraPandaScraper:
    BASE_URL = "https://www.ultrapanda.mobi"
    ENDPOINTS = {
        ...
        "pw_reset": f"{BASE_URL}/fast/user/updatePasswd"
    }
    GAME_NAME = "ultrapanda"
    GAME_INITIAL = "up"
    ...
    def __init__(self, username: str = None, password: str = None):
        self.username = username or settings.ULTRAPANDA_USER
        self.password = password or settings.ULTRAPANDA_PASS
        self.app_id = None
    ...
    def _build_params(self, **kwargs) -> dict:
        ...
        if kwargs.get("new_passwd") is not None:
            signature_param["new_passwd"] = kwargs["new_passwd"]

        return signature_param

    def _check_site_status(self) -> bool:
        try:
            response = requests.get("https://ht.ultrapanda.mobi", timeout=10)
